...
A PowerShell 7.4 runtime environment, an inline runbook bound to it plus one pulled from a URI, a daily schedule, a job schedule linking them, typed automation variables, and a module imported from the PowerShell Gallery.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_automation_account"></a> [automation\_account](#module\_automation\_account) | ../../ | n/a |
...
| <a name="output_runbook_ids"></a> [runbook\_ids](#output\_runbook\_ids) | n/a |
<!-- END_TF_DOCS -->
